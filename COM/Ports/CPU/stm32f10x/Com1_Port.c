...
/*-----------RCC------------------------------------------------------------------------------------------------------*/
    ...
    RCC_APB2PeriphClockCmd( RCC_APB2Periph_GPIOA | RCC_APB2Periph_AFIO, ENABLE);/* 1.Enable GPIO(Tx,Rx pins) clock    */
...
#if USE_DMA_TX_COM1
    RCC_AHBPeriphClockCmd(RCC_AHBPeriph_DMA1, ENABLE);             /* *4.clock for USART1 DMA1 channel4             */
#endif    
/*-----------NVIC-----------------------------------------------------------------------------------------------------*/
...
/*-----------GPIO-----------------------------------------------------------------------------------------------------*/                         
    ...
    GPIO_Init(GPIOA, &GPIO_InitStructure);                           /* 5.Init GPIO Tx                                */
                          
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
    GPIO_Init(GPIOA, &GPIO_InitStructure);                           /* 6.Init GPIO Rx                                */
