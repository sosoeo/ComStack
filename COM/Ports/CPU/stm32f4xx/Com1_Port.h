...
*          |                     Pin assignment                        |
*          +-----------------------------+---------------+-------------+
*          |  STM32F4xx USART1           |ILX3232|SN75176|    Pin      |
*          +-----------------------------+---------------+-------------+
...
#ifndef _COM1_PORT_H_
#define _COM1_PORT_H_
...
#define COM1_FPUTC(c)                       USART_SendData(USART1, (INT08U) c);\
...
#define COM1_TIM_IRQ_FLAG_CLEAR             TIM_ClearITPendingBit(TIM6,TIM_FLAG_Update)
#define COM1_TIM_ENABLE                     TIM_Cmd(TIM6, ENABLE)
#define COM1_TIM_DISABLE                    TIM_Cmd(TIM6, DISABLE)
#define COM1_TIM_SET_COUNTER                TIM_SetCounter(TIM6, 0)
...
void Com1RxTerminateSignal(void);    /* Post/Mark a flag to indicate that a message receiving have got a result/return*/
void Com1WaitRxTerminate(void);      /* Pend/Wait a flag which indicate that a message receiving overed,AND,clear flag*/
